	...
	<form id="query" method="post" action="php/getPlace.php">
		<section class = "sideFilter">
			...
			<ul>
				...
				<li>Filter Rules: 
					<br> <input type="radio" name="rules" onclick(value="1"> Yes
					<br> <input type="radio" checked="checked" name="rules" value="0"> No		
				<br>
				</li> Rules
				<br>
				<li>Pets Permitted: 
					<br> <input type="radio" name="pets" value="1"> Yes
					<br> <input type="radio" checked="checked" name="pets" value="0"> No	
				...
				<li>WheelchairAccessible:
					...
					<br> <input type="radio" checked="checked" name="wheelchair" value="0"> No
				<li>Smoking Permitted:
					<br> <input type="radio" name="smoking" value="1"> Yes
					<br> <input type="radio" checked="checked" name="smoking" value="0"> No
				<li>Outdoor Access:
					<br> <input type="radio" name="outdoors" value="1"> Yes
					<br> <input type="radio" checked="checked" name="outdoors" value="0"> No	
			</ul>
